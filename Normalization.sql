...
--3. Caegory inforamtion is repeated for each products 
--4. Subtotal is calcualted field( voilated 1NF)
--5. Difficult to maintain - chnaging a prodcut name requires mulitiple updates
